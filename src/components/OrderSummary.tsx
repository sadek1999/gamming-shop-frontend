...
//   const dispatch = useAppDispatch()
    const {tax,taxRate,grandTotal,totalPrice,selectedItems}= useAppSelector((store)=>store.card)
    // const handleClearCart=()=>{
    //   dispatch(clearCart())
    // }
  return (
    <div className=" lg:w-80 w-full h-full  rounded text-black">
      ...
      <div className="px-4 pb-6">
        ...
        <button
          ...
          className="bg-blue-400 px-3 py-2 text-white  mt-2 rounded-md w-full text-xs flex justify-between items-center"
        >
